...
int main() {
                ...
                if (length && length > 2 && data[0] == '4' && data[1] == '2') {
                        ...
                        if (s != "") {
                                ...
                                if (event == "telemetry") {
                                                ...
                                                if(d < (2+4*lane+2) && d > (2+4*lane-2) )
                                                {
                                                        ...
                                                        if((check_car_s > car_s) && ((check_car_s-car_s) < 30) && ((check_car_s-car_s) < closestDist_s ) )
                                                        {
                                                                ...
                                                                if((check_car_s-car_s) > 20)
                                                                {
                                                                        ...
                                                                        // Do some logic here - lower reference velocity so as not to crash into the car in front
                                                                        // and could also try to flag to change lanes
                                        ...
                                        // In Frenet add 30m evenly spaced points ahead of starting reference
                                        ...
                                        // Define the actual (x,y) that will be used in the planner
                                        vector<double> next_x_vals;
                                        vector<double> next_y_vals;

                                        // Start with all of the path points from the previous time
                                        ...
                                        // Calculate how to break up our spline point to enable us to travel at the desired referenced velocity
                                        ...
                                        // Fill up the rest of the planner, after filling in the previous points, here we will always output 50 points
                                        ...
                                        for (int i = 1; i <= 50-previous_path_x.size(); i++) {
                                                ...
                                                // Rotate it back to normal after rotating it earlier
        ...
        h.onHttpRequest([](uWS::HttpResponse *res, uWS::HttpRequest req, char *data,
                ...
                if (req.getUrl().valueLength == 1) {
                        ...
                        // Guess this could be done more gracefully
                        res->end(nullptr, 0);
                }
        });
